...
try {
    ...
    // FIXED: Query dengan perhitungan denda real-time untuk buku yang masih dipinjam
    $query = "
        SELECT p.*, 
    ...
    // Dikembalikan
    $stmt = $conn->prepare("SELECT COUNT(*) FROM peminjaman WHERE nik = ? AND status = 'dikembalikan'");
    $stmt->execute([$nik]);
    $stats['dikembalikan'] = $stmt->fetchColumn();
    ...
    $history = [];
    $stats = ['total' => 0, 'dipinjam' => 0, 'dikembalikan' => 0, 'terlambat' => 0];
}
...
<div class="container py-4">
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-md-3">
            <div class="stat-card green">
                <div class="stat-number"><?= $stats['dikembalikan'] ?></div>
    ...
    <div class="filter-card">
        <form method="GET" class="row g-3 align-items-end">
            ...
            <?php if (!empty($status)): ?>
                <div class="col-md-3">
                    <a href="peminjaman.php" class="btn-reset">
    ...
    <div class="table-card">
        <div class="table-card-header">
            <h5><i class="fas fa-list me-2"></i>Riwayat Peminjaman</h5>
        </div>
        <div>
                        ...
                        <tbody>
                            <?php $no = 1; foreach ($history as $row): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                        if (!empty($row['tanggal_pengembalian_aktual'])) {
                                            echo formatTanggal($row['tanggal_pengembalian_aktual']);
                                        } else {
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <p class="text-muted">Anda belum pernah meminjam buku. Mulai jelajahi katalog kami!</p>
