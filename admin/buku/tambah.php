...
// Fungsi baru: getRakCapacityInfo
...
if (isset($_POST['tambah_buku'])) {
    ...
    if (empty($isbn)) {
        ...
        $errors[] = 'Format ISBN tidak valid (harus 13 digit dimulai dengan 978 atau 979)';
    }
    ...
    // Validasi kapasitas rak jika dipilih
    if ($id_rak && $stok > 0) {
        $capacity_info = getRakCapacityInfo($id_rak);
        if ($capacity_info['max'] !== null && $capacity_info['free'] !== null) {
            if ($stok > $capacity_info['free']) {
                $errors[] = "Rak tidak memiliki cukup kapasitas. Sisa kapasitas: {$capacity_info['free']} buku. Stok yang ingin ditambahkan: {$stok} buku.";
            }
        }
    }
    ...
    if (empty($errors)) {
        try {
            ...
            if ($result) {
                ...
                logActivity(
                    'TAMBAH_BUKU', 
                    "Menambahkan buku: {$judul} oleh {$pengarang}" . 
...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <h1 class="h3 mb-0">
                <i class="fas fa-plus-circle me-2 text-success"></i>Tambah Buku Baru
            </h1>
        </div>
        <div>
                    ...
                    <form method="POST" id="bookForm" novalidate>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <div class="form-text mt-2">
                                    <a href="../penerbit/tambah.php" target="_blank" class="text-primary text-decoration-none">
                                        <i class="fas fa-plus-circle me-1"></i> Tambah Penerbit Baru
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <select name="id_rak" id="id_rak" class="form-control-modern">
                                    ...
                                    <?php foreach ($rak_list as $rak): 
                                        ...
                                        if ($capacity_info['max'] !== null) {
                                            $persentase = $capacity_info['max'] > 0 ? 
                                                round(($capacity_info['used'] / $capacity_info['max']) * 100) : 0;
                                            
                                            if ($capacity_info['free'] <= 0) {
                                                $capacity_text = ' (PENUH)';
                                                $capacity_class = 'capacity-danger';
                                            } elseif ($capacity_info['free'] < 10) {
                                                $capacity_text = " (Sisa: {$capacity_info['free']} buku - Hampir Penuh)";
                                                $capacity_class = 'capacity-warning';
                                            } else {
                                                $capacity_text = " (Sisa: {$capacity_info['free']} buku)";
                                ...
                                <div class="form-text mt-2">
                                    <a href="../rak/tambah.php" target="_blank" class="text-primary text-decoration-none">
                                        <i class="fas fa-plus-circle me-1"></i> Tambah Rak Baru
                                    </a>
                                </div>
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6">
                                <label class="form-label-modern" for="stok">
                                    ...
                                    <small class="text-muted d-block">(Jumlah buku fisik)</small>
                                </label>
                                <input type="number" 
                                       name="stok" 
                                       id="stok"
                                ...
                                <div class="form-text mt-2">
                                    <i class="fas fa-info-circle me-1"></i>
                                    Jumlah buku fisik yang akan disimpan di rak
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-text">
                                <a href="../kategori/tambah.php" target="_blank" class="text-primary text-decoration-none">
                ...
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <ul class="small text-muted mb-0">
                            ...
                            <li>Dimulai dengan 978 atau 979</li>
                    ...
                    <div class="mb-4">
                        <strong class="d-block mb-2">Sistem Rak Baru:</strong>
                        <ul class="small text-muted mb-0">
                            <li><strong>Kapasitas berdasarkan BUKU FISIK</strong></li>
                            <li>Pilih rak dengan sisa kapasitas mencukupi</li>
                            <li>Sistem akan memperingatkan jika kapasitas tidak cukup</li>
                            <li>Pilih "Tanpa Rak" jika buku belum ditempatkan</li>
                        </ul>
                    </div>
                ...
                <div class="card-body">
                    <div class="alert alert-warning small mb-0">
                        <ul class="mb-0">
                            ...
                            <li><strong>Periksa kapasitas rak sebelum menyimpan!</strong></li>
                        </ul>
                    </div>
                </div>
            </div>
...
function validateRakCapacity() {
    ...
    if (rakSelect.value && selectedOption.dataset.capacityFree !== undefined) {
        ...
        const capacityMax = parseInt(selectedOption.dataset.capacityMax);
        ...
        if (stok > capacityFree) {
            capacityWarning.classList.remove('d-none');
            capacityMessage.textContent = `Rak ini hanya memiliki ${capacityFree} slot kosong. Anda mencoba menambahkan ${stok} buku.`;
            return false;
        } else {
            capacityWarning.classList.add('d-none');
            return true;
...
document.getElementById('stok').addEventListener('input', validateRakCapacity);
...
document.getElementById('bookForm').addEventListener('submit', function(e) {
    ...
    if (!isbn || isbn.length !== 13 || !isbn.startsWith('978') && !isbn.startsWith('979')) {
        ...
        isbnField.nextElementSibling.nextElementSibling.textContent = 'ISBN harus 13 digit dan dimulai dengan 978 atau 979';
        isValid = false;
    }
    ...
    if (!validateRakCapacity()) {
        isValid = false;
        e.preventDefault();
        document.getElementById('capacityWarning').scrollIntoView({ behavior: 'smooth', block: 'center' });
    }
